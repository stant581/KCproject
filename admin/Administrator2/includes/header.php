<div class="navbar navbar-inverse set-radius-zero" >
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown">Clients/Projects<i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-contracts.php">Show Contracts</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-projects.php">Show Projects</a></li>
                                </ul>
                            </li>
                           <!-- 
                            <li>
 ...
 <!--<li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
									 ...
									 <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-contracts.php">Manage Contracts</a></li>
                                </ul>
                            </li>
-->
