                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT * from tblemployee where Type=2 and status=1";
...
{?>
  <a href="reg-employee.php?id=<?php echo htmlentities($result['eid']);?>" onclick="return confirm('Are you sure you want to active this employee?');"><button class="btn btn-primary">Active</button> 
                                            ...
                                            <td class="center">
                                            <a href="reg-employee.php?EID=<?php echo htmlentities($result['EID']);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
											<a href="reg-employee.php?del=<?php echo htmlentities($result['EID']);?>" onclick="return confirm('Are you sure you want to delete?');""><button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
                                            </td> -->
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
