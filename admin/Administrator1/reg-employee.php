...
{
    $eid = $_GET['del'];
    $sql = "DELETE FROM tblemployee where eid='$eid'";
    $conn->query($sql);
    header('location:reg-employee.php');
}
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            {
                                                echo htmlentities("Manager");
                                            } else {

                                            echo htmlentities("General");
											}
                                            ?></td>
...
{?>
  <a href="reg-employee.php?id=<?php echo htmlentities($result['eid']);?>" onclick="return confirm('Are you sure you want to active this employee?');"><button class="btn btn-primary">Active</button> 
                                            ...
                                            <td class="center">
                                            <a href="edit-employee.php?EID=<?php echo htmlentities($result['eid']);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
											<a href="reg-employee.php?del=<?php echo htmlentities($result['eid']);?>" onclick="return confirm('Are you sure you want to delete?');"><button class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Delete</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
